  ...
  return (
    <div className="relative flex items-center justify-center w-80 h-80 mx-auto">
      ...
      <svg className="absolute inset-0 w-full h-full animate-spin-slow opacity-30" viewBox="0 0 300 300">
        <circle cx="150" cy="150" r="140" fill="none" stroke="currentColor"
          strokeWidth="2" strokeDasharray="4 12" className={colorClass} />
      </svg>
      ...
      <svg className="absolute inset-0 w-full h-full animate-[spin_18s_linear_infinite_reverse] opacity-50" viewBox="0 0 300 300">
        <circle cx="150" cy="150" r="130" fill="none" stroke="currentColor"
          strokeWidth="1" strokeDasharray="60 40 20 40" className={colorClass} />
      </svg>

      {/* Main progress ring */}
      <svg className="relative w-full h-full transform -rotate-90" viewBox="0 0 300 300">
        <circle cx="150" cy="150" r={radius} fill="none"
          stroke="rgba(26, 26, 46, 0.8)" strokeWidth="12" />
        <circle cx="150" cy="150" r={radius} fill="none"
      ...
      <div className={`absolute flex flex-col items-center justify-center ${glowClass}`}>
        <div className="text-gray-500 font-mono text-sm tracking-widest mb-1">
          SYSTEM HEALTH
        </div>
        ...
        <div className="text-gray-500 font-mono text-xs mt-2">
          {prediction.health_label}    {/* ← shows Healthy / Fair / Poor / Critical */}
        </div>
      </div>
